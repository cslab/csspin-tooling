...
> and delete irrelevant ones and this note before submitting the merge request.
...
- Testing
  ...
  - [ ] Does the change radiate widely and could break e.g., project local
        plugins? If yes, testing and communication with stakeholders done?
- Documentation
...
<!-- Link any related issues or CRs -->
