...
want to share ideas, report issues, contribute code, or create releases for
the csspin-tooling project.

The csspin-tooling repository is hosted on a private GitLab instance, while the
repository itself is mirrored to
[GitHub](https://github.com/cslab/csspin-tooling) for public visibility.
...
- System requirements as documented in the [documentation](doc/installation.rst)

## Contribution Guidelines

Please follow the guidelines below when contributing to the csspin-tooling
project.
...
repository](https://github.com/cslab/csspin-tooling/issues) for reporting issues
...
3. Before marking the request as ready for review, make sure to address all of
   ...
   - [ ] Take your time to prepare the code and merge/pull request description
         before marking the request as ready for review. A well-prepared request
         will save a lot of time during the review process.
...
3. `git clone <your-fork-or-repo-url> csspin-tooling && cd csspin-tooling && pre-commit install`
...
7. Commit your changes with descriptive messages and ensure all pre-commit
   hooks pass.
...
> This section is only relevant for maintainers of the csspin-tooling project.

The version scheme used is major.minor.patch following semver.org.

Releases are created by csspin-tooling maintainers within the GitLab instance hosting
this repository.
...
1. Create the release notes by opening a new merge request at the csspin-tooling
